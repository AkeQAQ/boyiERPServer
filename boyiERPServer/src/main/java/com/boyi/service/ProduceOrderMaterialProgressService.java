...
public interface ProduceOrderMaterialProgressService extends IService<ProduceOrderMaterialProgress> {
    ...
    Page<ProduceOrderMaterialProgress> innerQueryByManySearch(Page page, String searchField, String queryField, String searchStr, List<Long> searchStatus, List<Long> searchStatus2, Map<String,String> otherSearch,String searchNoPropread,String searchStart,String searchEnd,String searchNoAllIn);
    ...
    ProduceOrderMaterialProgress groupByMaterialIdAndBetweenDateAndOrderIdIsNull(String id, String searchStartDate, String searchEndDate);
