...
public interface BaseSupplierMaterialMapper extends BaseMapper<BaseSupplierMaterial> {
    String querySql = "select bm.name as material_name ,bm.big_unit as unit,bm.specs as specs,bs.name as supplier_name,bsm.* from base_material bm,base_supplier bs,base_supplier_material bsm" +
